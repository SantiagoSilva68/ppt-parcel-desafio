const ganastee = new URL("../../images/resultadoGanaste.png", import.meta.url);
import { navigateTo } from "../../router";
export function ganaste() {
    class HasGanado extends HTMLElement {   
        constructor() {
            super();
            this.render();
        }
        ...
        div.innerHTML = `
            ...
            <img class="imagen-perdiste" src="${ganastee}"></img>
    ...
    customElements.define('juego-ganaste', HasGanado);
}