...
const empatastee = new URL("../../images/empataste.png", import.meta.url);
export function empataste() {
    class HasEmpatado extends HTMLElement {   
        constructor() {
            super();
            this.render();
        }
...
;
        ...
        div.innerHTML = `
            ...
            <img class="imagen-perdiste" src="${empatastee}"></img>
    ...
    customElements.define('juego-empataste', HasEmpatado);
}